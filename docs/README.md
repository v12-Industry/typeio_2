...
- [`development/visualizations/index.md`](development/visualizations/index.md) — what each graph visualization actually draws, one doc per visualization (starting with [Rootless](development/visualizations/rootless.md)); the switching mechanism itself is `architecture/visualization-switching.md`, linked from there.
